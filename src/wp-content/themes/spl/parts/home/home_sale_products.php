...
if ($acf_fc_layout !== 'home_sale_products') {
    return;
}
...
?>
<section id="section-<?= $id ?>" class="section section-products section-sale-products section-slide-products section-slides section-slide-shadow">
    <div class="container">

        <div class="group-title">
            <?= $home_product_title ? '<h2 class="section-title home-title">' . $home_product_title . '</h2>' : '' ?>
