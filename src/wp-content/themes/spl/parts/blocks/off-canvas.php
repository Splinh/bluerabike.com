...
if (!$img_logo):
	$html = sprintf(
		'<a href="%1$s" title="mobile-logo-canvas" class="mobile-logo-link" rel="home" aria-label="%2$s">%3$s</a>',
		\HD_Helper::home(),
	...
	$html = sprintf(
		'<a href="%1$s" title="mobile-logo-canvas" class="mobile-logo-link" rel="home">%2$s</a>',
		\HD_Helper::home(),
		$image
	);
endif;
