...
<div class="item">
    ...
    <div class="content">
        <div class="meta">
            ...
            <span class="date"><?= get_the_modified_date('d/m/Y', $post->ID) ?></span>
        </div>
        ...
        <a class="view-more" href="<?= get_permalink($post->ID) ?>" title="<?= \HD_Helper::escAttr($title) ?>"><?= _e('Chi tiết', TEXT_DOMAIN) ?></a>
    </div>
</div>